              ...
              <div class="chatbot-inner">
                ...
                ${this.blinkMode===t?T`
                    <div class="action-wrap">
                      ...
                      ${this.userInput?T`<img src="${"https://blink.danbee.ai/asset/danbee-blink/images/send.png"}" @click="${this._sendMessage}" title="보내기"/>`:""}
                      ${this.sttEnabled&&!this.userInput?T`<img src="${"https://blink.danbee.ai/asset/danbee-blink/images/mic.png"}" @click="${()=>this._changeBlinkMode({mode:i,balloonMsg:""})}" title="음성모드로 전환"/>`:""}
                    </div>
                  `:null}
